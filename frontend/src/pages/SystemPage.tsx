  ...
  return (
    <div className="p-8 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        ...
        <Card className="glass bg-black/20 backdrop-blur-md border-white/10 lg:col-span-2">
          <CardHeader>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex justify-between items-center p-3 border border-red-500/20 bg-red-500/5 rounded-lg border-l-2" style={{ borderLeftColor: '#ef4444' }}>
                  <div>
                    <div className="text-sm font-medium text-white">{ev.pod}</div>
                    <div className="text-xs text-white/50 mt-1">NS: {ev.namespace}</div>
                  </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <Card className="glass bg-black/20 backdrop-blur-md border-white/10 flex-1">
            ...
            <CardContent className="pb-4">
              <div className="space-y-3">
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-sm text-white">API Server Latency</span>
                  <span className="font-mono text-green-400 text-sm">12ms</span>
                </div>
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-sm text-white">etcd Leader Election</span>
                  <span className="text-xs px-2 py-0.5 bg-green-500/20 text-green-400 rounded">Stable</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-white">Scheduler Queue</span>
                  <span className="font-mono text-white/80 text-sm">0 pending</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="glass bg-black/20 backdrop-blur-md border-white/10 flex-1">
            ...
            <CardContent className="pb-4">
              <div className="space-y-3">
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-sm text-white">fluentd (Logging)</span>
                  <span className="text-xs font-mono text-white/50">24/24 ready</span>
                </div>
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-sm text-white">datadog-agent</span>
                  <span className="text-xs font-mono text-amber-400 animate-pulse">22/24 ready</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-white">node-exporter</span>
                  <span className="text-xs font-mono text-white/50">24/24 ready</span>
                </div>
              </div>
            </CardContent>

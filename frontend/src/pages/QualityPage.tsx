    ...
    <div className="p-6 md:p-8 space-y-6 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="flex flex-col gap-1">
          <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">Data Quality Center</h1>
          <p className="text-muted-foreground text-sm font-medium">Monitor real-time payload schemas and inspect rule violations.</p>
        </div>
        
        {/* Global SLA Summary */}
        <div className="flex gap-4 p-3 bg-black/20 backdrop-blur-md border border-white/10 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
          <div className="flex items-center gap-3 px-3">
            <div className="p-2 bg-green-500/20 rounded-lg"><ShieldCheck className="w-5 h-5 text-green-400" /></div>
            <div>
              <div className="text-[10px] text-white/50 uppercase tracking-wider font-bold">Global Score</div>
          ...
          <div className="flex items-center gap-3 px-3">
            ...
            <div>
              <div className="text-[10px] text-white/50 uppercase tracking-wider font-bold">Quarantined</div>
          ...
          <div className="flex items-center gap-3 px-3">
            ...
            <div>
              <div className="text-[10px] text-white/50 uppercase tracking-wider font-bold">Active Rules</div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="bg-black/20 backdrop-blur-md border border-white/10 rounded-lg p-1 w-fit mb-6 shadow-lg">
          <TabsList className="bg-transparent gap-1">
            ...
            <TabsTrigger value="rules" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-white/60">Quality Rules</TabsTrigger>
            <TabsTrigger value="violations" className="data-[state=active]:bg-white/10 data-[state=active]:text-white text-white/60">Violations (DLQ)</TabsTrigger>
          </TabsList>
        </div>
